...
class Motivations:
    ...
    def interest(self, array_interest, point, points_poses_list, history, goals, weights=(0.25, 0.25, 0.1)): #Hlavní 0.5, 0.25, 0.1
        ...
        array_interest.append([str(novelty_score), str(competence_score), str(diversification_score), str(interest_score)])

        return interest_score, array_interest
    ...
    def select_goal(self, selected_goals_list, array_interest):
        ...
        if np.random.random() < self.epsilon:
            ...
            array_interest.append(["rand", "rand", "rand", "rand"])
        else:
            ...
            for goal in self.goals_interest:
                ...
                interest_value, array_interest = self.interest(array_interest, goal, selected_goals_list, self.competence, self.goals_interest)
        ...
        selected_goals_list = np.append(selected_goals_list, [selected_goal], axis=0)
        print("Selected goal: ", selected_goal)
        return selected_goal, selected_goals_list, array_interest
